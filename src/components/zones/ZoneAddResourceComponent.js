...
// Component
function ZoneAddResourceComponent({request, zone, dispatch, handleClose}) {
    // Local state
...
ZoneAddResourceComponent.propTypes = {
...
export default React.memo(ZoneAddResourceComponent);
